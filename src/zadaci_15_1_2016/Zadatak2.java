...
public class Zadatak2 {
	...
	public static void main(String[] args) {
		...
		// Integeri koji ce sadržavati broj samoglasnika i suglasnika
		int samo = 0;
		int sugl = 0;
		...
		for (int i = 0; i < slova.length; i++) {
			...
			if (slova[i] == ' ') {
				i++; // Ako postoji prazno mjesto preskace se
			}
		...
		System.out.println("Unesena recenica ima " + samo + " samoglasnika i " + sugl + " suglasnika.");
